...
public class BatchAdvice extends CustomizingStatementAdvice implements MethodAdvice
{
    private final String            sql;
    private final boolean           transactional;
    private final ChunkSizeFunction batchChunkSize;

    public BatchAdvice(Class<?> sqlObjectType, ResolvedMethod method)
    {
